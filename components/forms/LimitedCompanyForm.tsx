    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-semibold text-brand-charcoal">Company Information</h2>
        ...
        {/* Person Fields Section (Contact) */}
        <div className="space-y-6">
          <h2 className="text-xl font-semibold text-brand-charcoal">Contact Information</h2>
